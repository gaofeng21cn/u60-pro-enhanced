...
static int web_action_allowed(const char *s) {
 ...
 "wifi.ap","wifi.channel","wifi.password","wifi.power","wifi.relay.connect","wifi.relay.off","wifi.relay.on","wifi.relay.scan","wifi.relay.select","wifi.relay.policy","wifi.relay.forget","wifi.relay.profiles","wifi.relay.profile","wifi.relay.manage","wifi.show_password","wifi.sleep","wifi.ssid",
 ...
 "usb.power_role","usb.role","clash.about","clash.close_connections","clash.delay","clash.diagnose","clash.favorite","clash.flush_dns","clash.global_target","clash.history","clash.mode","clash.provider","clash.rule_add","clash.rule_edit","clash.rule_provider","clash.select","clash.service",
 ...
 "diag.connections","diag.web","diag.network","band.lte","band.nsa","band.sa","cell.apn","cell.mode","router.dmz","router.dns","router.firewall","router.lan","router.nat","router.portforward","router.portmapping","router.upnp",
