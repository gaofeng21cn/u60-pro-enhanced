...
static int web_action_allowed(const char *s) {
 ...
 "usb.power_role","usb.role","usb.macnet.enable","usb.macnet.restore","clash.about","clash.close_connections","clash.delay","clash.diagnose","clash.favorite","clash.flush_dns","clash.global_target","clash.history","clash.mode","clash.provider","clash.rule_add","clash.rule_edit","clash.rule_provider","clash.select","clash.service",
